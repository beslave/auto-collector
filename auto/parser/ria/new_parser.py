...
class RiaNewParser(BaseRiaParser):
    ...
    async def get_advertisement_data(self, list_item_data):
        ...
        data = {
            ...
            'engine_fuel_rate_mixed': parse_float_to_int(api_data.get('fuel_rate'), 1000),
            'engine_fuel_rate_urban': parse_float_to_int(options.get(65), 1000),
            'engine_fuel_rate_extra_urban': parse_float_to_int(options.get(66), 1000),
